module github.com/kevfan/cloud-resource-operator
...
require (
	...
	github.com/kevfan/cloud-resource-operator/apis v0.0.0-00010101000000-000000000000
...
replace github.com/kevfan/cloud-resource-operator/apis => ./apis
