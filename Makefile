...
# integreatly.org/cloud-resource-operator-bundle:$VERSION and integreatly.org/cloud-resource-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= integreatly.org/cloud-resource-operator
